...
<div style="background-color:#6D1A08;height:550px;width:23%;float:left"><br><br><br>
	<div style="padding-left: 7px">
		...
		<a href="practice.jsp"><font color="white" size="6"> <u><i>VIEW REGISTERED</i></u></font></a>
	</div>
</div>
<div style="background-color:grey;height:550px;width:23%;float:right">
</div>
<img src="images\5909762-best-pictures.jpg" height=550px width=53.9%/>
